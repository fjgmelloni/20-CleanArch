...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\t.pb.OrderR\x06orders2\x7f\n" +
	"\fOrderService\x12>\n" +
	"\vCreateOrder\x12\x16.pb.CreateOrderRequest\x1a\x17.pb.CreateOrderResponse\x12/\n" +
	"\n" +
	"ListOrders\x12\t.pb.Empty\x1a\x16.pb.ListOrdersResponseB=Z;github.com/devfullcycle/20-CleanArch/internal/infra/grpc/pbb\x06proto3"
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	...
	2, // 2: pb.OrderService.ListOrders:input_type -> pb.Empty
